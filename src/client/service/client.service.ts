...
export class ClientService {
    ...
    // Créer un client
    async createClient(createClientDto: ClientDto, idUser: number) {
        createClientDto.createdBy = idUser;
    ...
    async replaceById(id: any, updateClientDto: ClientDto, idUser: number) {
